...
$.ajax({type:opts.method,url:opts.url,headers:opts.headers,data:_91c,dataType:"json",success:function(data){
_91d(data);
},error:function(){
...
$.ajax({type:opts.method,url:opts.url,headers:opts.headers,data:_b77,dataType:"json",success:function(data){
_b78(data);
},error:function(){
