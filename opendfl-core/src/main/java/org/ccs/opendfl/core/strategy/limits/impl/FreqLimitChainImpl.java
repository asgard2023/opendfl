...
public class FreqLimitChainImpl implements FreqLimitChain {
    ...
    @Resource(name = "freqLimitLimitStrategy")
    private FreqLimitStrategy freqLimitLimitStrategy;
    ...
    private FreqLimitStrategy freqLimitResIpStrategy;
    @Resource(name = "freqLimitResUserStrategy")
    private FreqLimitStrategy freqLimitResUserStrategy;
    ...
    public void initStrategy() {
        ...
        this.addLimit(this.freqLimitLimitStrategy);
